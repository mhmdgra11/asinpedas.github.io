                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                      ...
                      <td width='150' class='center'>
                       ...
                       <a data-toggle='tooltip' data-placement='top' title='Edit' style='margin-right:5px' class='btn btn-primary btn-sm' href='?page=tambah-laporan&id=$data[id_penugasan]'> <i class='icon-copy fa fa-plus'></i></a>";?>
                            <?php
                                echo "
                        </div>
                      </td>
